 ...
 * @param {Storage<K, V>} [storage=InMemoryStorageWrapper] - cache storage that implements CacheStorage<K, V> interface [must provide get(key) and set(key, value, expired) methods]
...
exports.default = (
	...
	const errorTTL = error > 0 ? Math.floor(error) : 1000;
